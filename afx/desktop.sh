...
echo "---> CREATING $NEW_DIRECTORY DIRECTORY INSIDE /home/$USER...."
eval "$PASSWORD sudo -S mkdir -p /home/$USER/$NEW_DIRECTORY"
echo "$GREEN CREATED $NEW_DIRECTORY DIRECTORY INSIDE /home/$USER $END_COLOR."
